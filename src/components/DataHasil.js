...
var DataHasil = [
    {
        ...
        percentage: '',
        batas:simbol,
        penjelasan: 'Tipe Realistic menikmati untuk mengoperasikan alat, mesin, atau kendaraan. Tipe ini cocok untuk kerja di outdoor, bekerja merawat hewan, merawat tanaman, dan berbagai pekerjaan detail lainnya. Rekomendasi jurusan seperti paramedik veteriner, peternakan, tata boga, pertanian, Pendidikan Penerbangan, Teknik Perkapalan, Teknik Sipil. Untuk mengembangkan tipe ini, kamu bisa mendalami pelajaran Bahasa Inggris, Matematika, Teknologi, Computing, Agriculture, Horticulture, Bisnis, dan Science',
        kalimat: 'Persentase kecocokan kamu untuk tipe',
    },
    {
        id: '2',
        icon: <BsPlayCircle style={{ fill:'#B48336', fontSize: "2em"}}/>,
